...
public interface ICruiseApplicationsRepository : IRepository<CruiseApplication>
{
    ...
    Task<CruiseApplication?> GetByIdWithFormsAndFormCContentAndResearchTasks(
    ...
    Task<List<CruiseApplication>> GetAllByUserIdWithFormAAndFormCContent(Guid userId, CancellationToken cancellationToken);
}
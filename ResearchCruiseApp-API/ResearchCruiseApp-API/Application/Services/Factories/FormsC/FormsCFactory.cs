    ...
    : IFormsCFactory
{
    public async Task<FormC> Create(FormCDto formCDto, CancellationToken cancellationToken)
    {
        ...
        await AddFormCShortResearchEquipments(formC, formCDto, alreadyAddedResearchEquipments, cancellationToken);
        await AddFormCLongResearchEquipments(formC, formCDto, alreadyAddedResearchEquipments, cancellationToken);
        await AddFormCResearchEquipments(formC, formCDto, alreadyAddedResearchEquipments, cancellationToken);
    ...
    private async Task AddFormCGuestUnits(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
    ...
    private async Task AddContracts(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
    ...
    private async Task AddFormCSpubTasks(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
    ...
    private async Task AddFormCPorts(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
    ...
    private async Task AddCruiseDaysDetails(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
    ...
    private async Task AddShipEquipments(FormC formC, FormCDto formCDto, CancellationToken cancellationToken)
    {
        foreach (var shipEquipmentDto in formCDto.ShipEquipments)
        {

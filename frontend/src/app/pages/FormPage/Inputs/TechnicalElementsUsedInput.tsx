                            ...
                            <div className="w-100 bg-light">
                                ...
                                {field.value.map((row: TechnicalElements, index: number) => (
                                    <div className="table-striped w-100 bg-primary text-white">
                                        <div
                                            className={'w-100 d-flex flex-row border flex-wrap p-3'}
                                        >
                                            <div
                                                className={
                                        ...
                                        >
                                            <div
                                                className=" text-center pt-2 pb-1 pt-xl-2 pe-xl-2 pb-xl-2 justify-content-center">
                                                <button
                                                    type="button"
                                    ...
                                    <div
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                props.form!.setValue(
                                                    props.name,
                                                    [...field.value, newTechnicalElements],
                                                    {
                                                        shouldValidate: true,
                                                        shouldDirty: true,
                                                    },

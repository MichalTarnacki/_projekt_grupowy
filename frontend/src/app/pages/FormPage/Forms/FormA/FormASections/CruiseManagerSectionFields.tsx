...
const cruiseManagerSameAsDeputyErrName =
    'cruiseManagerIsTheSameAsDeputyManager';
const cruiseManagerNorDeputyIsCurrentUserErrName =
    'cruiseManagerNorDeputyIsCurrentUser';
...
const CruiseAndDeputyManagerExtraValidation = () => {
    ...
    const deputyManager = formContext!.getValues(
        cruiseManagerSectionFieldNames.deputyManagerId,
    );
        ...
        validation: !formContext!.readOnly
            ? () => {
                ...
                if (
                    ...
                    deputyManager &&
                    areFieldsEqual &&
                    !cruiseManagerSameAsDeputyError
                ) {

...
export const FStandardDateField = (props:HTMLProps<any>) => {
    ...
    return displayContext ? <StandardDateField {...props}/> : <FormStandardDateField {...props}/>
}
...
export const FDateFieldOnlyYear = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <DateFieldOnlyYear {...props}/> : <FormDateFieldOnlyYear {...props}/>
}
...
export const FDateFieldEnd = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <StandardDateField {...props}/> : <FormDateFieldEnd {...props}/>
}
...
export const FDateFieldStart = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <StandardDateField {...props}/> : <FormDateFieldStart {...props}/>
}
...
export const FFloatField = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <TextField {...props}/> : <FormFloatField {...props}/>
}
...
export const FIntField = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <TextField {...props}/> : <FormIntField {...props}/>
}
...
export const FTextField = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <TextField {...props}/> : <FormTextField {...props}/>
}
export const FBoolField = (props:HTMLProps<any>) => {
    const displayContext = useContext(DisplayContext)
    return displayContext ? <BoolField {...props}/> : <FormBoolField {...props}/>
}
...
export const BoolField = (props: { className?: string }) => {
    ...
    return (
        <div className={"d-flex flex-row w-100"}>
            <div className={" field-common col-6 " + (Boolean(cellValue) ? " bg-primary text-white" : "")}
                >
                Tak
            </div>
            <div className={"field-common col-6 " + (!Boolean(cellValue) ? " bg-primary text-white" : "")}
...
export const FormSelectField = (props: { className?: string; options?: SelectOptions }) => {
    const {cellValue, setCellValue, field} = CellFormTools()
    return (
        <SelectWrapper
            value={props.options!.find((option) =>
                (option as SelectSingleValue)!.value == cellValue)
            }
